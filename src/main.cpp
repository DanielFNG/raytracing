...
int main()
{
    ...
    Material lambertian1{.reflective = false, .albedo = Vec3{0.8, 0.8, 0.0}};
    Material lambertian2{.reflective = false, .albedo = Vec3{0.1, 0.2, 0.5}};
    Material metal1{.reflective = true, .fuzz = 0.3, .albedo = Vec3{0.8, 0.8, 0.8}};
    Material metal2{.reflective = true, .fuzz = 1.0, .albedo = Vec3{0.8, 0.6, 0.0}};
    Material metal3{.reflective = true, .fuzz = 0.0, .albedo = Vec3{0.1, 0.2, 0.5}};
    ...
    world.add(Sphere{Vec3{1.0,0.0,-1.0}, 0.5, metal2});
    /*
